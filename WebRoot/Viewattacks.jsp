...
#myTable tr.header, #myTable tr:hover {
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     ...
     %>
   <center><br/><h2><font face="Yu Mincho Demibold" style="color: #00BFFF;"><font size="8" >View Attacks <br></font></font></h2></center>
...
<th style="width:20%; color:#8B0000">A_ID</th>
 <th style="width:20%; color:#8B0000">LOGINID</th>
 <th style="width:20%; color:#8B0000">ATTACK TYPE</th>
