...
#myTable tr.header, #myTable tr:hover {
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     ...
     %>
   <center><br/><h2><font face="Yu Mincho Demibold" style="color: #ff503a;"><font size="8" >View User Request <br></font></font></h2></center>
...
<th style="width:20%; color:#8B0000">USERID</th>
 <th style="width:20%; color:#8B0000">USERNAME</th>
...
<td>
<font color="green"><a href="Requestacceptservlet?uid=<%=pb.getLoginid()%>">Accept</a></font>
</td>
