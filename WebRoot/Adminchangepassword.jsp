...
<center>
<center><h2><font face="Yu Mincho Demibold" style="color: #ff503a;"><font size="8" >Change password</font></font></h2></center>

<form action="Adminchangepasswordservlet" style="width:900px;">
...
<center><label><font color="red" size="4"><% String status=request.getParameter("status"); if(status!=null){out.println(status);} %></font></label> </center>     
  ...
  <div class="myContainer" style="text-align: left">
    ...
    <input type="password" placeholder="Enter New Password" name="newpass" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" required>
