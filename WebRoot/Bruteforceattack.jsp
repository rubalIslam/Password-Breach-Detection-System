...
#myTable tr.header, #myTable tr:hover {
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     ...
     %>
   <center><br/><h2><font face="Yu Mincho Demibold" style="color: #ff503a;"><font size="8" >View BruteForceAttack Details <br></font></font></h2></center>
...
<th style="width:20%; color:#8B0000">AID</th>
 <th style="width:20%; color:#8B0000">LOGINID</th>
 <th style="width:20%; color:#8B0000">PASSWORD</th>
 <th style="width:20%; color:#8B0000">ATTACKTYPE</th>
...
<tr  class="header">
<td>
  <font color="green"><%=pb.getAid()%></font>
</td>
 <td>
 ...
 <td>
<font color="green"><%=pb.getPassword()%></font>
 </td>
 
  
  <td>
<font color="green"><%=pb.getAttacktype()%></font>
 </td>
