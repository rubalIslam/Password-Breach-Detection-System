...
public class Viewuserrequestdao extends DbCon {
	...
	public ArrayList<Profilebean> getuserrequest() {
		
		
		Connection con=getConnection();
		ArrayList<Profilebean> list=new ArrayList<Profilebean>();
		try {
			PreparedStatement ps=con.prepareStatement("select LOGINID,USERNAME,MAIL,MOBILE,GENDER,ADDRESS from USERINFO where STATUS=?");
